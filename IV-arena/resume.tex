...
\begin{tabular}{p{0.45\textwidth} p{0.45\textwidth}}
    ...
    \textbf{学历：}全日制（\textbf{学信网可查}） & \textbf{求职偏好：}不外包 / 不驻场 \\
\end{tabular}
\end{center}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item 通过 NSQ 消息队列异步削峰、rate 限流保护与 Ristretto 热点缓存 的组合优化，在活动流量下将写入链路峰值提升至 QPS 3k+，并保障系统稳定性。
    ...
    \item \textbf{其他}：
    \begin{itemize}
        \item AI相册: 通过xxx实现分类；通过 DBSCAN 聚类算法实现万级人脸库的无监督聚类，支持动态聚类中心更新，识别准确率达 97.3\%。
