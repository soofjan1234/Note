...
![调度器演化时间线](excalidraw/GMP.调度器演化时间线.png)
...
![传统多线程问题](excalidraw/GMP.传统多线程问题图.png)
...
![单线程用户态调度GM](excalidraw/GMP.单线程用户态调度图.png)
...
![老调度器瓶颈](excalidraw/GMP.老调度器瓶颈图.png)
...
1. 编译器会在函数入口相关的栈检查路径偷偷插入几行汇编代码，叫 `stack check`
...
![协作式抢占](excalidraw/GMP.协作式抢占机制.png)
...
![信号式抢占](excalidraw/GMP.信号式抢占机制.png)
